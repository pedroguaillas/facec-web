...
declare const PRESET_STYLES: readonly ["vega", "nova", "maia", "lyra", "mira", "luma", "sera", "rhea"];
...
declare const PRESET_FONTS: readonly ["inter", "geist-sans", "noto-sans", "nunito-sans", "figtree", "roboto", "raleway", "dm-sans", "public-sans", "outfit", "jetbrains-mono", "playfair-display", "oxanium", "manrope", "space-grotesk", "montserrat", "ibm-plex-sans", "source-sans-3", "instrument-sans", "geist-mono", "noto-serif", "roboto-slab", "merriweather", "lora"];
declare const PRESET_FONT_HEADINGS: readonly ["inherit", "inter", "geist-sans", "noto-sans", "nunito-sans", "figtree", "roboto", "raleway", "dm-sans", "public-sans", "outfit", "jetbrains-mono", "playfair-display", "oxanium", "manrope", "space-grotesk", "montserrat", "ibm-plex-sans", "source-sans-3", "instrument-sans", "geist-mono", "noto-serif", "roboto-slab", "merriweather", "lora"];
