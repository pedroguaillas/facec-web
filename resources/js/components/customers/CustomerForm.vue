...
import { IDENTIFICATION_TYPE_OPTIONS } from '@/types/customer';
...
const form = useForm<{
    ...
    type_identification: props.customer?.type_identification ?? 'cédula',
    identication: props.customer?.identication ?? '',
